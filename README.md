...
curl -LO https://github.com/linletian/myworktree/releases/download/v0.4.1/myworktree_v0.4.1_darwin_arm64.tar.gz
curl -LO https://github.com/linletian/myworktree/releases/download/v0.4.1/checksums.txt
shasum -a 256 -c checksums.txt --ignore-missing
tar -xzf myworktree_v0.4.1_darwin_arm64.tar.gz
...
Start from `v0.4.1` or newer for public release binaries. The earlier `v0.1.0` GitHub Release assets were withdrawn after post-release validation uncovered severe terminal interaction issues, and `v0.4.1` is the current recommended public release.
